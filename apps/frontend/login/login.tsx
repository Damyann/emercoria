      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1360px] items-center px-5 py-8 sm:px-8 lg:px-10">
        <div className="grid w-full items-stretch gap-6 lg:grid-cols-[1.08fr_.92fr]">
          <section className="relative overflow-hidden rounded-[28px] border border-emerald-400/24 bg-[linear-gradient(180deg,rgba(6,18,24,.92),rgba(2,7,12,.78))] p-5 shadow-[0_24px_64px_rgba(0,0,0,.45)] sm:p-7 lg:p-8">
            ...
            <span className="pointer-events-none absolute inset-[1px] rounded-[27px] border border-white/[0.04]"/>
            <Line className="top-0 w-[72%]"/><Line className="bottom-0 w-[68%]"/>
            <div className="relative flex h-full flex-col">
              ...
              <div className="mt-7 max-w-[640px]">
                ...
                <p className="mt-5 max-w-[560px] text-[15px] font-bold leading-7 text-white/62 sm:text-[16px]">Управлявай икономика, пазари, производство и надмощие в една браузърна стратегия. Влез и продължи развитието на своята нация в eMercoria.</p>
              </div>
              ...
              <div className="relative mt-8 flex min-h-[320px] flex-1 items-center justify-center overflow-hidden rounded-[26px] border border-emerald-400/18 bg-[linear-gradient(180deg,rgba(4,14,20,.78),rgba(2,7,12,.58))] p-6 sm:p-8">
                <span className="pointer-events-none absolute inset-0 bg-[radial-gradient(340px_220px_at_50%_50%,rgba(0,255,210,.14),transparent_58%),radial-gradient(240px_120px_at_50%_12%,rgba(255,255,255,.08),transparent_62%)]"/>
                <span className="pointer-events-none absolute inset-0 opacity-[.14] [background-image:radial-gradient(circle_at_center,rgba(255,255,255,.9)_1px,transparent_1.2px)] [background-size:28px_28px]"/>
                <div className="relative"><div className="absolute inset-[-10%] rounded-full bg-emerald-400/8 blur-3xl"/><Image src={logo} alt="eMercoria logo" priority className="relative mx-auto h-auto w-[min(100%,520px)] drop-shadow-[0_0_26px_rgba(0,255,210,.22)]"/></div>
              </div>
            </div>
          </section>
          <section className="relative overflow-hidden rounded-[28px] border border-emerald-400/34 bg-[linear-gradient(180deg,rgba(3,11,16,.985),rgba(2,7,12,.985))] p-[1.5px] shadow-[0_26px_70px_rgba(0,0,0,.62)]">
            <div className="relative h-full overflow-hidden rounded-[27px] bg-[linear-gradient(180deg,rgba(2,8,13,.985),rgba(2,6,11,.985))] p-5 sm:p-7">
              <span className="pointer-events-none absolute inset-0 bg-[radial-gradient(280px_140px_at_22%_0,rgba(255,255,255,.08),transparent_62%),radial-gradient(340px_180px_at_100%_0,rgba(0,255,210,.1),transparent_58%)] opacity-95"/>
              <span className="pointer-events-none absolute inset-[1px] rounded-[26px] border border-white/[0.04]"/>
              <Line className="top-0 w-[70%]"/><Line className="bottom-0 w-[74%]"/>
              <div className="relative mx-auto flex h-full w-full max-w-[480px] flex-col justify-center">
                <div className="mb-6">
                  ...
                  <p className="mt-3 text-[14px] font-bold leading-6 text-white/54">Използвай своя имейл и парола, за да влезеш в профила си и да продължиш играта.</p>
                </div>
                <form className="space-y-4">
                  <Field label="Имейл" placeholder="admin@emercoria.com" icon={<MailIcon className="h-[18px] w-[18px]"/>}/>
                  <Field label="Парола" type="password" placeholder="••••••••••••" icon={<LockIcon className="h-[18px] w-[18px]"/>}/>
                  <div className="flex items-center justify-between gap-4 px-1 pt-1">
                    ...
                    <button type="button" className="text-[12px] font-black uppercase tracking-[.14em] text-emerald-200/88 transition hover:text-white">Забравена парола</button>
                  </div>
                  <div className="pt-2"><PrimaryButton>Влизане</PrimaryButton></div>
                ...
                <div className="mt-7 rounded-[20px] border border-white/8 bg-[linear-gradient(180deg,rgba(6,14,22,.84),rgba(3,8,13,.92))] px-4 py-4">
                  <div className="text-[11px] font-black uppercase tracking-[.2em] text-white/42">Preview State</div>
                  <div className="mt-3 grid gap-3 sm:grid-cols-2">
                    <div className="rounded-[16px] border border-emerald-400/14 bg-emerald-500/6 px-4 py-3"><div className="text-[10px] font-black uppercase tracking-[.18em] text-white/42">Faction</div><div className="mt-2 text-[15px] font-black tracking-[.04em] text-white">Mercantile Crown</div></div>
                    <div className="rounded-[16px] border border-sky-400/14 bg-sky-500/6 px-4 py-3"><div className="text-[10px] font-black uppercase tracking-[.18em] text-white/42">Region</div><div className="mt-2 text-[15px] font-black tracking-[.04em] text-white">Northern Exchange</div></div>
                  </div>
                </div>
              </div>
            </div>
