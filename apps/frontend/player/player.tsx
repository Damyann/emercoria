...
const Btn=({label,children}:{label:string;children:React.ReactNode})=><button type='button' aria-label={label} className='flex h-11.5 w-11.5 items-center justify-center border border-black/10 bg-white text-[#1b1d21] shadow-[0_8px_24px_rgba(15,23,42,.08)] transition hover:bg-[#f3f4f6]'><span className='h-[22px] w-[22px]'>{children}</span></button>;
